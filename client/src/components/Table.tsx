...
import { ICustomer, IItem, IOrderWithProductsAndCustomer, IProduct } from "../interfaces/Interfaces";
...
function Table(props: {
	changeQuantity?: any;
	type: string;
	content: IProduct[]|ICustomer[]|IOrderWithProductsAndCustomer[];
	items?: IItem[];
}) {
	return (
		<div>
			<table id="Table_table">
				{props.content.map((oneContent: any) => (
